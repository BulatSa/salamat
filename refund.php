		...
		<div class="row">
			<div class="grid-6 grid-12_s">
				<div class="about-info__block">
					<p class="about-info__block-title h2"><img src="img/icons/sale-cancel.svg" alt="">Отказ от покупки</p>
			...
			<div class="grid-6 grid-12_s">
				<div class="about-info__block">
					<p class="about-info__block-title h2"><img src="img/icons/sale-refund.svg" alt="">Возврат и обмен товара</p>
					<div class="user-content">
